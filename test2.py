...
# colours assigned to variable number 
RED = 0
YELLOW = 1
GREEN = 2
BLUE = 3
...
class Robot:
    ...
    def __init__(self):
        ...
        #####################################################################
        self.explores = False # flag boolean 
        ...
        cv2.startWindowThread()
         ...
         ######################## publishers ############################       
        self.goal_pub = rospy.Publisher('/turtlebot/move_base_simple/goal',
...
#            self.depth_sub.unregister()
       ...
       # help calculate object centre so red dot location finder is in the centre 
